    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="mx-auto max-w-5xl px-6 py-24 text-center">
        ...
        <p className="mt-5 text-lg text-muted-foreground max-w-2xl mx-auto">
          Connect your database, manage its tables, import files (.shp, .geojson, .gpkg), scrape feature servers, visualize and edit spatial data, and share live map views—all from the browser.
        </p>
